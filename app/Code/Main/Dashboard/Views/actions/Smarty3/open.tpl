...
<ul>
    ...
    &nbsp;&nbsp;&nbsp;app/Code/Main/Dashboard/etc/config.xml<br /><br />
    
    <b>Main View</b>:<br /><br />
    
    &nbsp;&nbsp;&nbsp;app/Code/Main/Dashboard/Views/actions/Smarty3/open.tpl<br /><br />

    <b>JavaScript File</b>:<br /><br />
    
    &nbsp;&nbsp;&nbsp;app/Code/Main/Dashboard/web/js/actions.js<br /><br />
    <b>Tutorials</b>:
    <ul>
